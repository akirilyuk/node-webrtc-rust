...
- **Core / Opus SDP** — `createOffer` / `createAnswer` rewrite Opus `a=fmtp` to our params. Answers otherwise mirror a remote offer’s weak fmtp even when the local MediaEngine is correct (staging client-as-answerer case).
