...
| **voice-agent-local-sherpa** `start:roundtrip-counting-echo-lid-multi` | CLI (exits on success) | — | **5 concurrent** echo+LID sessions via `VoiceAgentSessionHost`, ultimate pool env, full one…ten + LID ordering — [ROUNDTRIP.md](./voice-agent-local-sherpa/ROUNDTRIP.md#counting-echo--lid--5-concurrent-sessions-ultimate-pool-env) |
