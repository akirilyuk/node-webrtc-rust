...
| **voice-agent-local-sherpa**              | Browser + Node server   | 3002             | Sherpa browser demo + CI roundtrip E2E scripts — [`ROUNDTRIP.md`](./voice-agent-local-sherpa/ROUNDTRIP.md) (incl. `roundtrip-barge-in` / `roundtrip-barge-in-buffered`, `roundtrip-tts-stream`, counting/echo/…) |
