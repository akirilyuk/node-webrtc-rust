...
| **voice-agent-local-sherpa**              | Browser + Node server   | 3002             | Sherpa browser demo; [`start:roundtrip`](./voice-agent-local-sherpa/ROUNDTRIP.md); [`start:roundtrip-counting`](./voice-agent-local-sherpa/ROUNDTRIP.md#counting-roundtrip-one-utterance-one-final) (1–20); [`start:roundtrip-counting-echo`](./voice-agent-local-sherpa/ROUNDTRIP.md#counting-echo-roundtrip-agent1--agent2-one--ten) (1↔2); [`start:roundtrip-counting-barge-recovery`](./voice-agent-local-sherpa/ROUNDTRIP.md#counting-barge-in-recovery-roundtrip) (barge + recovery); [`start:roundtrip-barge-in`](./voice-agent-local-sherpa/ROUNDTRIP.md#barge-in-e2e) |
...
| voice-agent-local-sherpa         | `download-stt:en` + `download-tts:en`; `start:roundtrip`; `start:roundtrip-counting`; `start:roundtrip-counting-echo`; `start:roundtrip-counting-barge-recovery` (models) | Roundtrip + counting + echo + barge recovery — [ROUNDTRIP.md](./voice-agent-local-sherpa/ROUNDTRIP.md) |
