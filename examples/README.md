...
| **voice-agent-local-sherpa-multi-client** | Browser + Node (3 tabs) | 3004             | **Three clients, one room**, shared Sherpa pool + `VOICE_MAX_CONCURRENT_SESSIONS`; see [README](./voice-agent-local-sherpa-multi-client/README.md)                                              |
