...
| **voice-agent-local-sherpa-multi-client**                  | Browser + Node (3 tabs) | 3004             | **Three clients, one room**; `start:mix-groups` for Voice+Data positional mix — [README](./voice-agent-local-sherpa-multi-client/README.md)                                                                                               |
