...
| voice-agent-local-sherpa         | `download-stt:en` + `download-tts:en`; `start:roundtrip`; `start:roundtrip-counting`; `start:roundtrip-counting-echo` (models) | Roundtrip + counting 1–20 + bidirectional echo 1–10 — [ROUNDTRIP.md](./voice-agent-local-sherpa/ROUNDTRIP.md) |
