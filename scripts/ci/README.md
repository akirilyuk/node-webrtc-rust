...
| [`run-helpers-unit-tests.sh`](run-helpers-unit-tests.sh)                                                                                | quality job, `npm run test:helpers`                     | vitest `@node-webrtc-rust/helpers` unit (excludes `*.integration.test.ts`) + multi-client example (no `.node`)                                                 |
